...
class HomeViewModel: ObservableObject {
    ...
    init() {
        fetched_puppies = [
            ...
            Pup(name: "Not Pauly", place: "other home", profilePic: "dog3"),
            Pup(name: "Not Psa", place: "other home1", profilePic: "dog4"),
            Pup(name: "Not Piwea", place: "other home2", profilePic: "dog5")
        ]
